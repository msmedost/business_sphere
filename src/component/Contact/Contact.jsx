        ...
        >
          ...
          <div className="contact-container">
            <div className="phone-no-container">
              <p className="contact-way flex items-center">
                <FaPhoneAlt className="icon-footer" /> +91-85 82 84 84 34
              </p>
            </div>
            <div className="phone-no-container">
              <p className="contact-way flex items-center">
                <IoMdMail className="icon-footer" /> sskjha2016@gmail.com
              </p>
            </div>
            <div className="phone-no-container">
              <p className="contact-way flex items-center">
                <FaLocationDot className="icon-footer" /> Kolkata 700001
              </p>
            </div>
          </div>
        </motion.div>
        <div className="img-and-form-container">
          ...
          <form className="form-container">
            ...
            <div className=" w-full flex justify-center items-center">
                <ReCAPTCHA sitekey="6Lc-BgkqAAAAANPa1aGXv6RVXeaSw2Q5qNArLZNK" />
            </div>
